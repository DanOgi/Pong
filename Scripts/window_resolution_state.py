class WindowResolutionState:
    ...
    RESOLUTION_320X240   = 320, 240, 4 #0
    RESOLUTION_480X320   = 480, 320, 8 #1
    RESOLUTION_640X480   = 640, 480, 12 #2
    RESOLUTION_800X480   = 800, 480, 16 #3
    RESOLUTION_800X600   = 800, 600, 20 #4
    RESOLUTION_1024X600  = 1024, 600, 24 #5
    RESOLUTION_1024X768  = 1024, 768, 28 #6
    RESOLUTION_1280X720  = 1280, 720, 32 #7
    RESOLUTION_1280X800  = 1280, 800, 36 #8
    RESOLUTION_1280X1024 = 1280, 1024, 40 #9
    RESOLUTION_1366X768  = 1366, 768, 44 #10
    RESOLUTION_1400X1050 = 1400, 1050, 48 #11
    RESOLUTION_1440X900  = 1440, 900, 52 #12
    RESOLUTION_1600X900  = 1600, 900, 56 #13
    RESOLUTION_1600X1024 = 1600, 1024, 60 #14
    RESOLUTION_1600X1200 = 1600, 1200, 60 #15
    RESOLUTION_1680X1050 = 1680, 1050, 60 #16
    RESOLUTION_1920X1080 = 1920, 1080, 64 #17
