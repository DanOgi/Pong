...
class Menu:
    def __init__(self, game_mode) -> None:
        ...
        self.game_button = Button(self.screen, 
        ...
        self.option_button = Button(self.screen, 
    ...
    def run(self):
        ...
        while self.running:
            ...
            if self.game_button.on_hover():
                self.game_button.text_color = (255, 255, 255)
            else:
                self.game_button.text_color = (200, 200, 200)

            if self.option_button.on_hover():
                self.option_button.text_color = (255, 255, 255)
            else:
                self.option_button.text_color = (200, 200, 200)
            
            if self.exit_button.on_hover():
                self.exit_button.text_color = (255, 255, 255)
            else:
                self.exit_button.text_color = (200, 200, 200)
